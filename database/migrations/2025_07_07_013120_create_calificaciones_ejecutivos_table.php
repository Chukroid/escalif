...
return new class extends Migration
{
    ...
    {
        Schema::create('calificaciones_ejecutivos', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('bloque1', 3, 1);
            $table->decimal('bloque2', 3, 1);
    ...
    {
        Schema::dropIfExists('calificaciones_ejecutivos');
    }
};
